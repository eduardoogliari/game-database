...
module.exports = function (pool) {
    ...
    router.get('/', (req, res) => __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            const whereQuery = (nomeEmpresa)
                ? (0, pg_format_1.default)("WHERE UPPER(nome) LIKE UPPER(%L)", '%' + nomeEmpresa + '%')
                : '';
    ...
    router.get('/:empresaId', (req, res) => __awaiter(this, void 0, void 0, function* () {
        try {
            const id = req.params.empresaId;
            const result = yield pool.query("SELECT id, nome, logo_url, descricao FROM empresa WHERE empresa.id=$1", [id]);
            let empresa = {
                'id': undefined,
                'nome': '',
                'logo_url': '',
